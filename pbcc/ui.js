...
makeChartOverview = function(){
  ...
  // NOTE: makeChartOverview is currently unused — the live overview is rendered by
  // makeChartHistorical (which is fully data-driven). Years are derived from the
  // data so this stays correct across the extended 2010-2022 range if revived.
  var years = (locationData['year'] || ['2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022']).map(String);
